...
import { Areacharts1Component } from '../charts/areacharts1/areacharts1.component';
import { Areacharts2Component } from '../charts/areacharts2/areacharts2.component';
import { TimelinechartComponent } from '../charts/timelinechart/timelinechart.component';

@Component({
  selector: 'app-dashboard',
  standalone: true,
  imports: [CommonModule,LineChartComponent,Areacharts1Component,Areacharts2Component,TimelinechartComponent],
